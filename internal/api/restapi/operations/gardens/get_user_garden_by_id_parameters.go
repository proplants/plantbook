...
func NewGetUserGardenByIDParams() GetUserGardenByIDParams {
	...
	return GetUserGardenByIDParams{}
}

// GetUserGardenByIDParams contains all the bound params for the get user garden by ID operation
// typically these are obtained from a http.Request
//
// swagger:parameters getUserGardenByID
type GetUserGardenByIDParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*Numeric ID of the user's garden to get.
	  Required: true
	  In: path
	*/
	GardenID int64
...
func (o *GetUserGardenByIDParams) bindGardenID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
