...
type DeleteUserGardenURL struct {
	GardenID int64
...
func (o *DeleteUserGardenURL) Build() (*url.URL, error) {
	...
	if gardenID != "" {
		...
		return nil, errors.New("gardenId is required on DeleteUserGardenURL")
	}
...
func (o *DeleteUserGardenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteUserGardenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteUserGardenURL")
	}
