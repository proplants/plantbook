...
func NewGetUserGardensParams() GetUserGardensParams {
	...
	return GetUserGardensParams{}
}

// GetUserGardensParams contains all the bound params for the get user gardens operation
// typically these are obtained from a http.Request
//
// swagger:parameters getUserGardens
type GetUserGardensParams struct {
...
func (o *GetUserGardensParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUserGardensParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
