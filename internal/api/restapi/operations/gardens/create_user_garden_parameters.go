...
func NewCreateUserGardenParams() CreateUserGardenParams {
	...
	return CreateUserGardenParams{}
}

// CreateUserGardenParams contains all the bound params for the create user garden operation
// typically these are obtained from a http.Request
//
// swagger:parameters createUserGarden
type CreateUserGardenParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*New garden parameters without id
	  Required: true
	  In: body
	*/
...
func (o *CreateUserGardenParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.Garden
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("garden", "body", ""))
			} else {
				res = append(res, errors.NewParseError("garden", "body", "", err))
			}
		} else {
