...
func NewGetRefPlantByIDParams() GetRefPlantByIDParams {
	...
	return GetRefPlantByIDParams{}
}

// GetRefPlantByIDParams contains all the bound params for the get ref plant by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters getRefPlantById
type GetRefPlantByIDParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*ID of reference plant to return
	  Required: true
	  In: path
	*/
	ID int64
...
func (o *GetRefPlantByIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
