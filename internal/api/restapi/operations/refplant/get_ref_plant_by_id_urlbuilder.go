...
type GetRefPlantByIDURL struct {
	ID int64
...
func (o *GetRefPlantByIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetRefPlantByIDURL")
	}
...
func (o *GetRefPlantByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRefPlantByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRefPlantByIDURL")
	}
